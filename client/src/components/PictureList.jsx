  ...
  <div className="popdishText">
    ...
    <div className="pictureWrapper">
      <div className="mySlides">
        <img className="photo" src= "https://loremflickr.com/320/240/meal?random=1" alt="FOOD1"></img>
        <br></br>
      ...
      <br></br>
      <div className="mySlides">
        <img className="photo" src="https://loremflickr.com/320/240/meal?random=2" alt="FOOD1"></img>
        <div className="dishName">Burrito</div>
        <div className="photoReview">5 photos - 39 reviews</div>
      </div>
      <br></br>
      <div className="mySlides">
        <img className="photo" src="https://loremflickr.com/320/240/meal?random=3" alt="FOOD1"></img>
        <div className="dishName">Beef</div>
        <div className="photoReview">2 photos - 12 reviews</div>
      </div>
      <br></br>
      <div className="mySlides">
        <img className="photo" src="https://loremflickr.com/320/240/meal?random=4" alt="FOOD1"></img>
